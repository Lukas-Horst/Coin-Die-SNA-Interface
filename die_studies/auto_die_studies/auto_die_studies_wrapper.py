...
class AutoDieStudiesWrapper(PipelineWrapper):
    ...
    def run(self) -> str:
        ...
        sim_matrix_path = os.path.join(self.run_output_dir, f"matching_{matching_algo}_{clustering_algo}.npy")
        ...
        csv_path = os.path.join(self.run_output_dir, f"clustering_{matching_algo}_{clustering_algo}.csv")
        ...
        json_filename = f"sna_data_{matching_algo}_{clustering_algo}.json"
